package org.bluepowerrobotics.lmau.converter.provider.dashscope;
...
public final class DashScopeChatModel implements ChatModel {
    ...
    private static Object toDashScopeToolChoice(ChatRequest request) {
        if (request.getToolChoice() == org.bluepowerrobotics.lmau.converter.core.ToolChoice.FUNCTION
    ...
    private static ResponseFormat toDashScopeResponseFormat(ChatRequest request) {
        if (request.getResponseFormat() == org.bluepowerrobotics.lmau.converter.core.ResponseFormat.JSON_OBJECT) {
            return ResponseFormat.from(ResponseFormat.JSON_OBJECT);
        }
        if (request.getResponseFormat() == org.bluepowerrobotics.lmau.converter.core.ResponseFormat.JSON_SCHEMA) {
